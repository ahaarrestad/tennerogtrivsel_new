...
describe('buildScriptSrc', () => {
    ...
    it.each([undefined, null, 'sha256-abc'])(
        'kaster FatalError med formatfeilmelding når scriptHashes er %s (ikke en liste)',
        (input) => {
            expect(() => buildScriptSrc(input)).toThrow(FatalError);
        }
    );
