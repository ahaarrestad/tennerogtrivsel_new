                    ...
                    <div class="flex justify-between items-start gap-4">
                        <div class="flex items-center gap-2">
                            ...
                            <div class="flex flex-col gap-1">
                                <button data-idx="${i}" data-dir="-1" class="settings-reorder-btn admin-reorder-btn" ${isFirst ? 'hidden' : ''} title="Flytt opp">
                                ...
                                <button data-idx="${i}" data-dir="1" class="settings-reorder-btn admin-reorder-btn" ${isLast ? 'hidden' : ''} title="Flytt ned">
